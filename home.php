...
<div class="box-container">
    ...
    <div class="box">
        ...
        <div class="user">
            <img src="./images/pic-1.jpg" alt="mahitha pfp">
            <div class="user-info">
                <h3>Mahitha</h3>
                <span>Goa</span>
            </div>
    ...
    <div class="box">
        ...
        <div class="user">
            <img src="./images/pic-2.png" alt="harshitha pfp">
            <div class="user-info">
                <h3>Harshitha</h3>
    ...
    <div class="box">
        ...
        <div class="user">
            <img src="./images/pic-3.jpg" alt="Nikhitha pfp">
            <div class="user-info">
                <h3>Nikhitha</h3>
                <span>Kerala</span>
            </div>
...
<section class="footer">
    ...
    <div class="credit">&copy;2024 Travelscapes</div>
